...
public class Search extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            prepareStatement.setString(2,"http://localhost:8080/SearchEngine/Search?keyword="+keyword);
...
//            for(com.minSearchEngine.SearchResult result:results){
